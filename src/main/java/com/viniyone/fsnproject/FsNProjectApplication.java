...
public class FsNProjectApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Category cat4 = new Category(null, "Pets");
		Category cat5 = new Category(null, "Miscellaneous");
		Category cat6 = new Category(null, "Sports");
		Category cat7 = new Category(null, "Clothing");
